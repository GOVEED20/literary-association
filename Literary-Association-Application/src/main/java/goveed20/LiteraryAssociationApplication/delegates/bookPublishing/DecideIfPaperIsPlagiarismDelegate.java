...
@Service
public class DecideIfPaperIsPlagiarismDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution delegateExecution) {
        ...
        delegateExecution.setVariable("is_plagiarism", data.get("plagiarism_option").equals("Plagiarism"));
