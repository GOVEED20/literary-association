...
@Service
public class CorrectPaperAccordingToSuggestionsDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution delegateExecution) {
        ...
        WorkingPaper paper;
        try {
            paper = bookService.submitPaper(delegateExecution.getProcessInstanceId(),
                    (String) data.get("correct_suggestions"));
